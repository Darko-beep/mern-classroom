...
// Define component styles using Material-UI's makeStyles
...
export default function Courses(props) {
  ...
  // Function to check if the course is not in the user's enrolled courses
...
// PropTypes to ensure the correct prop types are passed to the component
Courses.propTypes = {
  courses: PropTypes.array.isRequired,
  common: PropTypes.array.isRequired // assuming common is a required prop
}
